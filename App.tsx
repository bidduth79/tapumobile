...
const ProtectedLayout = () => {
  ...
  // Hide footer on specific routes (YouTube Feed/Newsroom, AI Hub)
  const hideFooter = location.pathname.includes('latest_updates') || location.pathname.includes('ai-hub');
